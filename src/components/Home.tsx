      ...
      <header className="relative h-[70vh] flex flex-col justify-center items-center text-center px-4">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <form className="max-w-md mx-auto">
              <div className="flex"> 
                  <div className="relative w-full">
                      <input type="text" className="subscribe__input subscribe__input:focus" placeholder="Type your email..." required />
                      <button type="submit" className="absolute top-0 end-0 h-full p-2.5 text-sm font-medium   bg-purple-500  border border-purple-500  ">
                          Subscribe 
                      </button>
                  </div>
              </div>
          ...
          <p className='text-gray-400 text-sm mt-12'>
            Subscribe to our newsletter for the latest updates and insights on AI and technology.
            By subscribing, you agree to our <Link to="/privacy-policy" className="text-blue-400 hover:text-blue-300 pr-2">Privacy Policy</Link>
            and <Link to='/term-of-use' className="text-blue-400 hover:text-blue-300">Term of use</Link>.
          </p>
